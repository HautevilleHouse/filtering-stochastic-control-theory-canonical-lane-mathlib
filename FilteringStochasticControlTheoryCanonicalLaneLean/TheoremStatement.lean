...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "filtering stochastic control theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
